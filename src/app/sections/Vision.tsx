...
// const Vision = () => {
//   return (
//     <div className="flex flex-col p-10 py-20 h-screen">
//       <div className=" flex text-xl sm:4xl md:text-5xl font-normal pb-9 text-right">
//         <h1>
...
//           <div className="bg-gray-100 p-14 rounded-3xl flex flex-col pt-20 justify-center">
